...
- **Gameplay Flow**: Pieces spawn, move, rotate, fall, lock, clear lines, send garbage lines to the opponent, score, detect loss, continue after one player loses, show winner/draw, and restart.
