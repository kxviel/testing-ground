...
- **Special Objects**: Every 4 seconds, each active board can spawn a shuffled-bag special object on a supported free tile with a clear approach path. Objects expire after 10 seconds, timed effects last 10 seconds, speed effects are 2x, and the teleporter swaps boards/pieces without changing scores.
