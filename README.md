...
- **Special Objects**: Every 4 seconds, each active board can spawn a shuffled-bag special object with effects like gravity changes, rotation delay, explosions, portals, and board swaps.
