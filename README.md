...
- **Special Objects**: Every 4 seconds, each active board can spawn a shuffled-bag special object that expires after 10 seconds. Timed effects last 10 seconds, speed effects are 2x, and swaps exchange boards/pieces without changing scores.
